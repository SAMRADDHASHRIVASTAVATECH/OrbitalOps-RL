...
MISSIONS: Dict[str, Dict[str, Any]] = {
    "orbit_stabilization_1": {
        ...
        "description": "Routine orbit stabilization. Minor thruster drift detected. Systems nominal.",
        "expected_actions": [
    ...
    "orbit_stabilization_2": {
        ...
        "description": "URGENT: Space debris on collision course. Evasive maneuvers required immediately.",
        "expected_actions": [
            {"category": "navigation", "priority": "high", "decision": "adjust"},
            {"category": "system_failure", "priority": "medium", "decision": "continue"},
        ],
        "initial_state": {
            "position": [6871.0, 0.0, 0.0],
            "velocity": [0.0, 7.8, 0.0],
    ...
    "lunar_landing_1": {
        ...
        "description": "Initiating lunar descent sequence. Targeting Mare Tranquillitatis landing zone.",
        "expected_actions": [
            {"category": "navigation", "priority": "high", "decision": "adjust"},
    ...
    "lunar_landing_2": {
        ...
        "description": "CRITICAL: Fuel leak detected. Must land immediately. Nearest safe zone 5km away.",
        "expected_actions": [
    ...
    "docking_procedure_1": {
        ...
        "description": "ISS docking approach initiated. Alignment at 2.3 degrees. RCS thrusters active.",
        "expected_actions": [
    ...
    "docking_procedure_2": {
        ...
        "description": "WARNING: Primary RCS thruster failure. Using backup thrusters only. Docking required.",
        "expected_actions": [
            {"category": "system_failure", "priority": "high", "decision": "adjust"},
            {"category": "navigation", "priority": "high", "decision": "adjust"},
    ...
    "emergency_rescue_1": {
        ...
        "description": "MAYDAY RECEIVED: Crew stranded in decaying orbit. O2 supply critical. ETA 90 minutes.",
        "expected_actions": [
            {"category": "navigation", "priority": "high", "decision": "adjust"},
            {"category": "resource_management", "priority": "high", "decision": "adjust"},
            {"category": "navigation", "priority": "high", "decision": "continue"},
    ...
    "emergency_rescue_2": {
        ...
        "description": "EXTREME EMERGENCY: Solar storm incoming. Radiation levels rising. Extract crew NOW.",
        "expected_actions": [
            {"category": "system_failure", "priority": "high", "decision": "adjust"},
            {"category": "navigation", "priority": "high", "decision": "adjust"},
    ...
    "asteroid_mining_1": {
        ...
        "description": "Long-range navigation to near-Earth asteroid. Gravity-assist maneuvers planned.",
        "expected_actions": [
            {"category": "navigation", "priority": "medium", "decision": "adjust"},
    ...
    "asteroid_mining_2": {
        ...
        "description": "ALERT: Unexpected mass concentration detected. Trajectory deviation 15%. Correcting...",
        "expected_actions": [
            {"category": "navigation", "priority": "high", "decision": "adjust"},
    ...
    "solar_storm_evasion_1": {
        ...
        "description": "Solar flare detected. Radiation front ETA 4 minutes. Seeking magnetosphere protection.",
        "expected_actions": [
            {"category": "navigation", "priority": "high", "decision": "adjust"},
            {"category": "system_failure", "priority": "medium", "decision": "adjust"},
            {"category": "navigation", "priority": "high", "decision": "continue"},
    ...
    "solar_storm_evasion_2": {
        ...
        "description": "CATASTROPHIC: X9-class flare. All systems shutting down. Emergency protocol OMEGA.",
        "expected_actions": [
    ...
    "satellite_repair_1": {
        ...
        "description": "Hubble telescope antenna misalignment detected. EVA repair mission authorized.",
        "expected_actions": [
            {"category": "navigation", "priority": "medium", "decision": "adjust"},
            {"category": "navigation", "priority": "low", "decision": "continue"},
        ],
    ...
    "satellite_repair_2": {
        ...
        "description": "DANGER: Micrometeorite swarm detected. Hull integrity compromised. Repair critical.",
        "expected_actions": [
            {"category": "system_failure", "priority": "high", "decision": "adjust"},
            {"category": "navigation", "priority": "high", "decision": "adjust"},
            {"category": "resource_management", "priority": "medium", "decision": "adjust"},
    ...
    "mars_transfer_1": {
        ...
        "description": "Interplanetary transfer window opening. Trans-Mars injection burn in T-30 minutes.",
        "expected_actions": [
            {"category": "navigation", "priority": "high", "decision": "adjust"},
            {"category": "resource_management", "priority": "medium", "decision": "adjust"},
            {"category": "navigation", "priority": "medium", "decision": "continue"},
    ...
    "mars_transfer_2": {
        ...
        "description": "ENGINE FAILURE: Main thruster offline. Using backup propulsion. Trajectory error 8%.",
        "expected_actions": [
            {"category": "system_failure", "priority": "high", "decision": "adjust"},
            {"category": "navigation", "priority": "high", "decision": "adjust"},
            {"category": "resource_management", "priority": "high", "decision": "adjust"},
